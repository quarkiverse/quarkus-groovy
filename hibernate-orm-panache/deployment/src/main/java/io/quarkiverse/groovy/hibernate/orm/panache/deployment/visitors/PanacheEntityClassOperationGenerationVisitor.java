 ...
 */
package io.quarkiverse.groovy.hibernate.orm.panache.deployment.visitors;
...
public class PanacheEntityClassOperationGenerationVisitor extends ClassVisitor {
    ...
    private static final String ANNOTATION_TYPE_NAME = String.format("L%s;", Transient.class.getName().replace('.', '/'));
